...
import net.mcreator.prehistoricworld.procedure.ProcedureInfoKeyBindingOnKeyPressed;
...
public class KeyBindingInfoKeyBinding extends ElementsPrehistoricWorld.ModElement {
	private KeyBinding keys;
	public KeyBindingInfoKeyBinding(ElementsPrehistoricWorld instance) {
		super(instance, 17);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.infokeybinding", Keyboard.KEY_I, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureInfoKeyBindingOnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
