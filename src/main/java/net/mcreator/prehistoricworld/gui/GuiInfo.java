...
package net.mcreator.prehistoricworld.gui;
...
public class GuiInfo extends ElementsPrehistoricWorld.ModElement {
	public static int GUIID = 3;
	public static HashMap guistate = new HashMap();
	public GuiInfo(ElementsPrehistoricWorld instance) {
		super(instance, 13);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				PrehistoricWorld.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("prehistoricworld:textures/info.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Info", 9, 9, -12566464);
			this.fontRenderer.drawString("Version 0.3.3", 9, 180, -12566464);
		}
		...
		protected void actionPerformed(GuiButton button) {
			PrehistoricWorld.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
