...
public class GuiDrAlanGrantGui extends ElementsPrehistoricWorld.ModElement {
	public static int GUIID = 4;
	public static HashMap guistate = new HashMap();
	public GuiDrAlanGrantGui(ElementsPrehistoricWorld instance) {
		super(instance, 24);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("prehistoricworld:textures/dralangrantgui.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Dr. Alan Grant", 7, 2, -12566464);
		}
