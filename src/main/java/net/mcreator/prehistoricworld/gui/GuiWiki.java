...
public class GuiWiki extends ElementsPrehistoricWorld.ModElement {
	public static int GUIID = 2;
	public static HashMap guistate = new HashMap();
	public GuiWiki(ElementsPrehistoricWorld instance) {
		super(instance, 12);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("prehistoricworld:textures/wiki.png");
		@Override
