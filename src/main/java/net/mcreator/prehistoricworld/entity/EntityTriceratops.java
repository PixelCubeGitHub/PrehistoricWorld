...
package net.mcreator.prehistoricworld.entity;
...
public class EntityTriceratops extends ElementsPrehistoricWorld.ModElement {
	public static final int ENTITYID = 3;
	public static final int ENTITYID_RANGED = 4;
	public EntityTriceratops(ElementsPrehistoricWorld instance) {
		super(instance, 5);
	}
	...
	public void initElements() {
		elements.entities.add(
				() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("prehistoricworld", "triceratops"), ENTITYID)
						.name("triceratops").tracker(64, 3, true).egg(-13408768, -10053376).build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("savanna")), Biome.REGISTRY.getObject(new ResourceLocation("plains")),
				Biome.REGISTRY.getObject(new ResourceLocation("river")),};
		EntityRegistry.addSpawn(EntityCustom.class, 20, 2, 5, EnumCreatureType.CREATURE, spawnBiomes);
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new Modelcustom_model(), 1f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("prehistoricworld:textures/triceratops.png");
				}
			};
		});
	}
	public static class EntityCustom extends EntityAnimal {
		...
		protected void initEntityAI() {
			...
			this.tasks.addTask(8, new EntityAITempt(this, 1, new ItemStack(Items.WHEAT, (int) (1)).getItem(), false));
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
					.getObject(new ResourceLocation("prehistoricworld:living-sound"));
		}

		@Override
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
					.getObject(new ResourceLocation("prehistoricworld:hurt-sound"));
		}

		@Override
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
					.getObject(new ResourceLocation("prehistoricworld:death-sound"));
		}
	...
	public static class Modelcustom_model extends ModelBase {
		...
		public Modelcustom_model() {
			...
			RBein.addChild(Fuss);
			Fuss.cubeList.add(new ModelBox(Fuss, 0, 48, -8.2105F, -1.9895F, -12.2F, 4, 2, 4, 0.0F, false));
			...
			Oberschenkel.cubeList.add(new ModelBox(Oberschenkel, 50, 48, -8.2105F, -17.7601F, -4.3682F, 4, 9, 4, 0.0F, false));
			...
			Unterschenkel.cubeList.add(new ModelBox(Unterschenkel, 34, 48, -8.0105F, -4.723F, -11.387F, 4, 9, 4, 0.0F, false));
			...
			Fuss2.cubeList.add(new ModelBox(Fuss2, 0, 48, -8.2105F, -1.9895F, -12.2F, 4, 2, 4, 0.0F, false));
			...
			Oberschenkel2.cubeList.add(new ModelBox(Oberschenkel2, 50, 48, -8.2105F, -17.7601F, -4.3682F, 4, 9, 4, 0.0F, false));
			...
			Unterschenkel2.cubeList.add(new ModelBox(Unterschenkel2, 34, 48, -8.0105F, -4.723F, -11.387F, 4, 9, 4, 0.0F, false));
			...
			Fuss3.cubeList.add(new ModelBox(Fuss3, 16, 48, 3.8F, -2.0F, 3.5F, 4, 2, 5, 0.0F, false));
			...
			Unterschenkel3.cubeList.add(new ModelBox(Unterschenkel3, 34, 48, 4.007F, -6.5156F, 4.3311F, 4, 9, 4, 0.0F, false));
			...
			Oberschenkel3.cubeList.add(new ModelBox(Oberschenkel3, 50, 48, 3.7895F, -16.17F, -2.8682F, 4, 9, 4, 0.0F, false));
			...
			Fuss4.cubeList.add(new ModelBox(Fuss4, 16, 48, 3.8F, -2.0F, 3.5F, 4, 2, 5, 0.0F, false));
			...
			Unterschenkel4.cubeList.add(new ModelBox(Unterschenkel4, 34, 48, 4.007F, -6.5156F, 4.3311F, 4, 9, 4, 0.0F, false));
			...
			Oberschenkel4.cubeList.add(new ModelBox(Oberschenkel4, 50, 48, 3.7895F, -16.17F, -2.8682F, 4, 9, 4, 0.0F, false));
			...
			Bauch.cubeList.add(new ModelBox(Bauch, 0, 75, -5.9F, -20.3567F, -10.0229F, 11, 9, 8, 0.0F, false));
			Bauch2 = new ModelRenderer(this);
			Bauch2.setRotationPoint(0.0F, 0.0F, 0.0F);
			Koerper.addChild(Bauch2);
			Bauch2.cubeList.add(new ModelBox(Bauch2, 86, 94, -6.0F, -19.6962F, -5.527F, 12, 9, 9, 0.0F, false));
			...
			Bauch3.cubeList.add(new ModelBox(Bauch3, 72, 112, -5.9F, -19.9693F, -0.0081F, 11, 10, 6, 0.0F, false));
			bone = new ModelRenderer(this);
			bone.setRotationPoint(1.0F, 0.0F, 0.0F);
			setRotationAngle(bone, -0.4363F, 0.0F, 0.0F);
			Koerper.addChild(bone);
			bone.cubeList.add(new ModelBox(bone, 76, 80, -5.0F, -10.0F, -21.0F, 8, 7, 7, 0.0F, false));
			bone2 = new ModelRenderer(this);
			bone2.setRotationPoint(0.0F, 0.0F, 0.0F);
			Koerper.addChild(bone2);
			bone2.cubeList.add(new ModelBox(bone2, 106, 84, -3.5F, -17.2381F, -18.8063F, 7, 6, 4, 0.0F, false));
			bone3 = new ModelRenderer(this);
			bone3.setRotationPoint(0.0F, 0.0F, 0.0F);
			Koerper.addChild(bone3);
			bone3.cubeList.add(new ModelBox(bone3, 36, 92, -5.9F, -18.3567F, -5.0229F, 11, 11, 8, 0.0F, false));
			bone4 = new ModelRenderer(this);
			bone4.setRotationPoint(0.0F, 0.0F, 0.0F);
			setRotationAngle(bone4, -0.1745F, 0.0F, 0.0F);
			Koerper.addChild(bone4);
			bone4.cubeList.add(new ModelBox(bone4, 38, 80, -5.8F, -10.3727F, -14.224F, 11, 4, 8, 0.0F, false));
			bone5 = new ModelRenderer(this);
			bone5.setRotationPoint(0.0F, 0.0F, 0.0F);
			setRotationAngle(bone5, 0.1745F, 0.0F, 0.0F);
			Koerper.addChild(bone5);
			bone5.cubeList.add(new ModelBox(bone5, 0, 100, -5.8F, -10.7279F, 4.28F, 11, 4, 7, 0.0F, false));
			bone10 = new ModelRenderer(this);
			bone10.setRotationPoint(0.0F, 0.0F, 1.0F);
			setRotationAngle(bone10, 0.0873F, 0.0F, 0.0F);
			Koerper.addChild(bone10);
			bone10.cubeList.add(new ModelBox(bone10, 28, 111, -5.85F, -17.63F, -0.37F, 11, 6, 11, 0.0F, false));
			bone11 = new ModelRenderer(this);
			bone11.setRotationPoint(0.0F, 0.0F, 0.0F);
			setRotationAngle(bone11, -0.1745F, 0.0F, 0.0F);
			Koerper.addChild(bone11);
			bone11.cubeList.add(new ModelBox(bone11, 0, 121, -5.85F, -14.18F, 4.4F, 11, 4, 3, 0.0F, false));
			...
			Schild.cubeList.add(new ModelBox(Schild, 16, 62, -8.2F, -13.0F, -33.0F, 16, 12, 1, 0.0F, false));
			...
			Stacheln.cubeList.add(new ModelBox(Stacheln, 8, 71, 4.6F, -4.0F, -32.9F, 4, 2, 0, 0.0F, false));
			Stacheln.cubeList.add(new ModelBox(Stacheln, 8, 71, -8.6F, -4.0F, -32.9F, 4, 2, 0, 0.0F, true));
			Stacheln.cubeList.add(new ModelBox(Stacheln, 8, 71, -7.3F, -13.3F, -32.9F, 2, 4, 0, 0.0F, false));
			Stacheln.cubeList.add(new ModelBox(Stacheln, 8, 71, 5.3F, -13.3F, -32.9F, 2, 4, 0, 0.0F, false));
			Stacheln.cubeList.add(new ModelBox(Stacheln, 8, 71, 4.6F, -12.0F, -32.9F, 4, 2, 0, 0.0F, false));
			Stacheln.cubeList.add(new ModelBox(Stacheln, 8, 71, -8.6F, -12.0F, -32.9F, 4, 2, 0, 0.0F, true));
			Stacheln.cubeList.add(new ModelBox(Stacheln, 8, 71, -4.3F, -13.3F, -32.9F, 2, 4, 0, 0.0F, false));
			Stacheln.cubeList.add(new ModelBox(Stacheln, 8, 71, 2.2F, -13.3F, -32.9F, 2, 4, 0, 0.0F, false));
			Stacheln.cubeList.add(new ModelBox(Stacheln, 8, 71, 4.6F, -8.0F, -32.9F, 4, 2, 0, 0.0F, false));
			Stacheln.cubeList.add(new ModelBox(Stacheln, 8, 71, -8.6F, -8.0F, -32.9F, 4, 2, 0, 0.0F, true));
			Stacheln.cubeList.add(new ModelBox(Stacheln, 8, 71, -1.0F, -13.3F, -32.9F, 2, 4, 0, 0.0F, false));
			Kopf2 = new ModelRenderer(this);
			Kopf2.setRotationPoint(0.0F, 9.0F, 31.0F);
			setRotationAngle(Kopf2, 0.0873F, 0.0F, 0.0F);
			Kopf.addChild(Kopf2);
			Kopf2.cubeList.add(new ModelBox(Kopf2, 50, 61, -3.7F, -15.9927F, -35.8292F, 7, 7, 7, 0.0F, false));
			Kopf3 = new ModelRenderer(this);
			Kopf3.setRotationPoint(0.0F, 9.0F, 31.0F);
			setRotationAngle(Kopf3, 0.3491F, 0.0F, 0.0F);
			Kopf.addChild(Kopf3);
			Kopf3.cubeList.add(new ModelBox(Kopf3, 78, 65, -2.7035F, -21.9702F, -36.6561F, 5, 4, 6, 0.0F, false));
			...
			Hoerner.cubeList.add(new ModelBox(Hoerner, 0, 67, -3.0F, -38.0F, -12.0F, 1, 7, 1, 0.0F, false));
			Hoerner.cubeList.add(new ModelBox(Hoerner, 0, 67, 2.0F, -38.0F, -12.0F, 1, 7, 1, 0.0F, false));
			...
			Hoerner2.cubeList.add(new ModelBox(Hoerner2, 4, 72, -0.7F, -32.0F, -29.0F, 1, 2, 1, 0.0F, false));
			...
			Hoerner3.cubeList.add(new ModelBox(Hoerner3, 0, 67, -3.0F, -46.3328F, -5.2343F, 1, 7, 1, 0.0F, false));
			Hoerner3.cubeList.add(new ModelBox(Hoerner3, 0, 67, 2.0F, -46.3328F, -5.2343F, 1, 7, 1, 0.0F, false));
			...
			bone6.cubeList.add(new ModelBox(bone6, 98, 59, -4.0F, -17.3F, 8.0872F, 7, 7, 5, 0.0F, false));
			bone7 = new ModelRenderer(this);
			bone7.setRotationPoint(0.0F, 10.0F, -19.0F);
			setRotationAngle(bone7, -0.1745F, 0.0F, 0.0F);
			Schwanz.addChild(bone7);
			bone7.cubeList.add(new ModelBox(bone7, 98, 48, -3.0F, -16.5124F, 19.1432F, 6, 5, 6, 0.0F, false));
			bone8 = new ModelRenderer(this);
			bone8.setRotationPoint(0.0F, 10.0F, -12.0F);
			setRotationAngle(bone8, -0.0873F, 0.0F, 0.0F);
			Schwanz.addChild(bone8);
			bone8.cubeList.add(new ModelBox(bone8, 78, 48, -2.25F, -13.968F, 17.2385F, 4, 5, 6, 0.0F, false));
			bone9 = new ModelRenderer(this);
			bone9.setRotationPoint(0.0F, 11.0F, -12.0F);
			Schwanz.addChild(bone9);
			bone9.cubeList.add(new ModelBox(bone9, 66, 48, -1.0F, -12.3972F, 23.9696F, 2, 4, 4, 0.0F, false));
		}
		...
		public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
			...
			this.RBein.rotateAngleX = MathHelper.cos(f * 0.6662F + (float) Math.PI) * f1;
