...
public class EntityDrAlanGrant extends ElementsPrehistoricWorld.ModElement {
	public static final int ENTITYID = 5;
	public static final int ENTITYID_RANGED = 6;
	public EntityDrAlanGrant(ElementsPrehistoricWorld instance) {
		super(instance, 21);
	}
	...
	public void initElements() {
		elements.entities.add(
				() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("prehistoricworld", "dralangrant"), ENTITYID)
						.name("dralangrant").tracker(64, 3, true).egg(-16724788, -3407872).build());
	}
