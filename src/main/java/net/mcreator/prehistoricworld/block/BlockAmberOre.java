...
import net.mcreator.prehistoricworld.item.ItemAmber;
import net.mcreator.prehistoricworld.creativetab.TabPrehistoricOres;
import net.mcreator.prehistoricworld.ElementsPrehistoricWorld;

import java.util.Random;

@ElementsPrehistoricWorld.ModElement.Tag
public class BlockAmberOre extends ElementsPrehistoricWorld.ModElement {
	@GameRegistry.ObjectHolder("prehistoricworld:amberore")
	public static final Block block = null;
	public BlockAmberOre(ElementsPrehistoricWorld instance) {
		super(instance, 2);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("prehistoricworld:amberore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		public BlockCustom() {
			...
			setLightLevel(0F);
			setLightOpacity(255);
			setCreativeTab(TabPrehistoricOres.tab);
		}
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemAmber.block, (int) (1)));
		}
	}
}
